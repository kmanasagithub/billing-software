    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark px-2">
            <a className="navbar-brand" href="">
                <img src={assets.logo} alt="Logo" height="70" className="logo"/>
            </a>
            ...
            <div className="collapse navbar-collapse p-2" id="navbarNav">
                ...
                <ul className="navbar-nav ms-auto ms-md-0 me03 me-lg-4">
                    <li className="nav-item dropdown">
                        <a href="#" className="nav-link dropdown-toggle" id="navbarDropdown"
                            role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src={assets.profile} alt="" height={75} width={75} className="logo"/>
                        </a>
